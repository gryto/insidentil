...
import 'component/pdff.dart';

class LapinsusPage extends StatefulWidget {
  // final id;
  const LapinsusPage({Key? key}) : super(key: key);

  @override
  State<LapinsusPage> createState() => _LapinsusPageState();
}

class _LapinsusPageState extends State<LapinsusPage> {
